...
; CHECK-LABEL: @test1(
; CHECK-NEXT:    [[CALL1:%.*]] = call range(i32 0, 2000) i32 @callee()
; CHECK-NEXT:    [[CALL2:%.*]] = call range(i32 0, 2000) i32 @callee()
; CHECK-NEXT:    [[NARROW:%.*]] = add nuw nsw i32 [[CALL1]], [[CALL2]]
; CHECK-NEXT:    [[ADD:%.*]] = zext nneg i32 [[NARROW]] to i64
; CHECK-NEXT:    ret i64 [[ADD]]
;
  %call1 = call range(i32 0, 2000) i32 @callee()
  %call2 = call range(i32 0, 2000) i32 @callee()
...
; CHECK-LABEL: @test11(
; CHECK-NEXT:    [[CALL1:%.*]] = call range(i32 -2000, 0) i32 @callee()
; CHECK-NEXT:    [[CALL2:%.*]] = call range(i32 -2000, 0) i32 @callee()
; CHECK-NEXT:    [[NARROW:%.*]] = add nsw i32 [[CALL1]], [[CALL2]]
; CHECK-NEXT:    [[ADD:%.*]] = sext i32 [[NARROW]] to i64
; CHECK-NEXT:    ret i64 [[ADD]]
;
  %call1 = call range(i32 -2000, 0) i32 @callee()
  %call2 = call range(i32 -2000, 0) i32 @callee()
...
; CHECK-LABEL: @test13(
; CHECK-NEXT:    [[CALL1:%.*]] = call range(i32 -512, -255) i32 @callee()
; CHECK-NEXT:    [[CALL2:%.*]] = call range(i32 -128, 0) i32 @callee()
; CHECK-NEXT:    [[NARROW:%.*]] = sub nsw i32 [[CALL1]], [[CALL2]]
; CHECK-NEXT:    [[SUB:%.*]] = sext i32 [[NARROW]] to i64
; CHECK-NEXT:    ret i64 [[SUB]]
;
  %call1 = call range(i32 -512, -255) i32 @callee()
  %call2 = call range(i32 -128, 0) i32 @callee()
  %sext1 = sext i32 %call1 to i64
  %sext2 = sext i32 %call2 to i64
